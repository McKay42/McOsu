...
public:
	...
	inline OsuDifficultyCalculator::Attributes getDifficultyAttributes() const {return m_difficulty_attributes;}
...
private:
	...
	OsuDifficultyCalculator::Attributes m_difficulty_attributes;
